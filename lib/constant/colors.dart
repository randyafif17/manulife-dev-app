...
class AppColor {
  ...
  static const int _redPrimaryValue = 0xffCB1A12;
  ...
  static const Color greenColor = Color(0xff00AC5B);
  ...
  static const Color secondaryColor = Color(0xff414865);

  static const Color bluePrimary2 = Color(0xff29B7E8);

  static const Color bluePrimary3 = Color(0xff0017E3);

  static const Color greyColor = Color(0xff979C9E);

  static const  Color formColor = Color(0xffF6F6F6);
