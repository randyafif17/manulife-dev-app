...
class BorderStyles {
  ...
  static OutlineInputBorder focusTextField = OutlineInputBorder(
    borderSide: BorderSide(color: AppColor.weakColor, width: Strokes.thin),
    borderRadius: Corners.lgBorder,
  );
...
class TextStyles {
  ...
  static TextStyle get h4 =>
      h1.copyWith(fontSize: FontSizes.s26, fontFamily: 'Helvetica Neue');
  static TextStyle get h5 =>
      h1.copyWith(fontSize: FontSizes.s20, fontFamily: 'Helvetica Neue');
  static TextStyle get h6 =>
      h3.copyWith(fontSize: FontSizes.s18, fontFamily: 'Helvetica Neue');
